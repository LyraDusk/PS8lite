...
We can just as easily exponentiate the predictions back out, which doesn't require changing the test set at all. 
1. If I transformed the outcome variable now, what will I have to make sure to do later on?
You'd have to exponentiate it back into the original variable space before submission. 
...
![](images/score_screenshot_random_forest.png){ width=100% }
